...
df_base_long <- process_df(df_base, "Group T0")
df_015_long <- process_df(df_015, "Group TL")
df_03_long <- process_df(df_03, "Group TM")
df_045_long <- process_df(df_045, "Group TH")
...
all_trend <- paste0(save_dir, "full_contribute_trend_alltreatment_1127.png")
ggsave(
  filename = all_trend,  
