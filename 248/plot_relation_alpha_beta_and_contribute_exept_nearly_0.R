...
all_trend <- paste0(save_dir, "relation_alpha_contribution_except_nearly01128.png")
ggsave(
  filename = all_trend,  
  plot = plot_alpha_agg, 
  device = "png", 
...
all_trend1 <- paste0(save_dir, "relation_beta_contribution_except_nearly01128.png")
ggsave(
  filename = all_trend1,  
  plot = plot_beta_agg, 
  device = "png", 
