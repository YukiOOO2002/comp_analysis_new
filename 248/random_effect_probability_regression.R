...
file_name <- "FErandom_Probability_Regression_full.tex"
...
modelsummary(list(model_plm_dum, model_plm_arr_multi),
             title = "Random Effect Probability Regression full",
             stars = TRUE, 
             output = full_path,
...
file_name1 <- "FErandom_Probability_Regression_non.tex"
full_path1 <- paste0(save_dir, file_name1)

modelsummary(list(model_plm_dum,model_plm_arr_multi_non),
             title = "Random Effect Probability Regression non",
             stars = TRUE, 
             output = full_path1,
             add_rows = rows_to_add,
             gof_map = c(
